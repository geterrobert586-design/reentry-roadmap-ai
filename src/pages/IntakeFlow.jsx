...
export default function IntakeFlow() {
  ...
  }, [hasFamilyConnection, hasMissingDocuments, hasSupervision, housingStatus, lifeTracks])
            ...
            {documentOptions.map((option) => (
              <label key={option} className="flex items-center gap-2">
                <input
                  ...
                  onChange={() => toggleSelection(option, documentStatus, setDocumentStatus)}
                />
                {option}
              </label>
            ))}
            ...
            {trackOptions.map((option) => (
              <label key={option} className="flex items-center gap-2">
                <input
                  ...
                  onChange={() => toggleSelection(option, lifeTracks, setLifeTracks)}
                />
                {option}
              </label>
            ))}
